...
?>
<body>
<center><h1 style=" color:white; background-color:Black; padding:15px; font-size:50px">*** Manager Page ***</h1></center>
...
<?php
	...
	foreach($result as $r)
	{
		...
		echo "<td>".$r["p_t_price"]."</td>";
		echo "<td>".$r["date"]."</td>";
		echo '<td><a href="confirmOrder.php?id='.$r["id"].'" class="btn btn-success">Confirm</a></td>';
		echo "</tr>";
	}
