...
<body>
	<table align="right" align="center" width="30%" height="200">
		<tr>
			<td>
				<?php require "managerRegistration.php";?>
			</td>
		</tr>
	</table>

<table border="2" align="center" width="70%" bgcolor="#B7B0B0">
<?php
$s_value="";
if(isset($_POST['searchManager']))
{
...
?>
	<form method="post" action="">
		<input style="width:960px" type="text" placeholder="Search By Name" name="search_value" value="<?php echo $s_value; ?>">
